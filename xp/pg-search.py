...
Il y a des cas où on se demande ce que l'on voudrait faire.
- Agence Pôle Emploi à Cosne-sur-Loire: on veut bien regrouper avec les agences FT trouvées également.
- Lorsque l'adresse est totalement fausse, que faire ? Mon intuition est qu'elle devrait compter "moins".
- Lorsque l'adresse "fonctionne" (même rue) mais le nom est totalement différent (exemple: FT et DDETS meme immeuble) => plutot non ?
