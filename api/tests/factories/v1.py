...
class StructureFactory(factory.alchemy.SQLAlchemyModelFactory):
    ...
    di_surrogate_id = factory.LazyAttribute(lambda o: f"{o.source}-{o.original_id}")
    is_best_duplicate = None
    cluster_id = None

    original_id = factory.Faker("slug", locale="fr_FR")
    id = factory.LazyAttribute(lambda o: f"{o.source}--{o.original_id}")
