...
def upgrade() -> None:
    op.add_column(
        "api__services", sa.Column("_is_valid_v0", sa.Boolean(), nullable=False)
    )
    op.add_column(
        "api__services", sa.Column("_is_valid_v1", sa.Boolean(), nullable=False)
    )
    op.add_column(
        "api__structures", sa.Column("_is_valid_v0", sa.Boolean(), nullable=False)
    )
    op.add_column(
        "api__structures", sa.Column("_is_valid_v1", sa.Boolean(), nullable=False)
    )
