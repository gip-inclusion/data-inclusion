...
from data_inclusion.api.analytics.services import (
    save_analytics_consult_service_event,
    save_analytics_consult_structure_event,
    save_analytics_services_list_event,
    save_analytics_services_search,
    save_analytics_structures_list_event,
)
...
def retrieve_structure_endpoint(
    ...
    service = services.retrieve_structure(
        db_session=db_session,
        source=source,
        id_=id,
    )
...
def search_services_endpoint(
    ...
    * les résultats sont triés par distance croissante.
    ...
    services_listed = services.search_services(
        request,
        db_session,
        sources=sources,
