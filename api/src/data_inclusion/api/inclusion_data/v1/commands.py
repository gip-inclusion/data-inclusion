...
def validate_dataset(
    ...
    if not structures_df.empty:
        ...
        structures_df = structures_df.loc[structures_df["_has_valid_address"] == True]  # noqa: E712
    ...
    if not services_df.empty:
        ...
        services_df = services_df.loc[
            (services_df["_has_valid_address"] == True)  # noqa: E712
            | services_df["modes_mobilisation"].apply(
                lambda modes: modes is None or "se-presenter" not in modes
            )
        ]
        services_df = services_df.loc[
