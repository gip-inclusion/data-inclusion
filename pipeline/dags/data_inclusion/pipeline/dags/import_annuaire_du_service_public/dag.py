...
SOURCE_ID = "annuaire-du-service-public"
...
def extract(to_path: str):
    ...
    from data_inclusion.pipeline.dags.import_annuaire_du_service_public import constants
...
def load(schema_name: str, from_s3_path: str):
    ...
    pg.to_pg(
        ...
        table_name=constants.FILENAME.removesuffix(".json"),
    )
...
def import_annuaire_du_service_public():
    chain(
...
dag = import_annuaire_du_service_public()
