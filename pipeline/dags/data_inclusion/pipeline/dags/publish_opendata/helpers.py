...
def clean_up(
    ...
    structures_df = remove_closed_sources(structures_df)
    structures_df = remove_pii(structures_df)
    structures_df = remove_invalid_rows(structures_df)
    structures_df = remove_internal_columns(structures_df)
    ...
    services_df = remove_closed_sources(services_df)
    services_df = remove_pii(services_df)
    services_df = remove_invalid_rows(services_df)
    services_df = remove_internal_columns(services_df)
