...
Typical staging tests include:

* testing that tables have an unique id
* testing tables references each other
* testing that a column is limited to a given set of expected values
* testing that a column is not always null
* testing that a column does not have empty strings
* testing that important columns are filled enough
