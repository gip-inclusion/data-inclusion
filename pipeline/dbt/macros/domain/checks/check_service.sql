...
CREATE OR REPLACE FUNCTION LIST_SERVICE_ERRORS(
        ...
        thematiques TEXT[],
        types TEXT[],
        volume_horaire_hebdomadaire FLOAT,
...
BEGIN
    {% set checks = [
            ...
            ("nombre_semaines", "nombre_semaines IS NULL OR nombre_semaines > 0"),
            ...
            ("volume_horaire_hebdomadaire", "volume_horaire_hebdomadaire IS NULL OR volume_horaire_hebdomadaire >= 0"),
