...
WITH mapping_thematiques AS (
    ...
    FROM (
        ...
        ('Trouver une alternance', 'trouver-un-emploi', 'trouver-un-emploi--suivre-ses-candidatures-et-relancer-les-employeurs'),
        ('Trouver une alternance', 'trouver-un-emploi', 'trouver-un-emploi--convaincre-un-recruteur-en-entretien'),
        ('Trouver une alternance', 'trouver-un-emploi', 'trouver-un-emploi--faire-des-candidatures-spontanees'),
        ('Trouver une alternance', 'trouver-un-emploi', 'trouver-un-emploi--repondre-a-des-offres-demploi'),
        ('Trouver un contrat d''apprentissage', 'trouver-un-emploi', 'trouver-un-emploi--suivre-ses-candidatures-et-relancer-les-employeurs'),
        ('Trouver un contrat d''apprentissage', 'trouver-un-emploi', 'trouver-un-emploi--convaincre-un-recruteur-en-entretien'),
        ('Trouver un contrat d''apprentissage', 'trouver-un-emploi', 'trouver-un-emploi--faire-des-candidatures-spontanees'),
        ('Trouver un contrat d''apprentissage', 'trouver-un-emploi', 'trouver-un-emploi--repondre-a-des-offres-demploi'),
        ('Préparer une candidature', 'trouver-un-emploi', 'preparer-sa-candidature--valoriser-ses-competences'),
        ('Rédiger une lettre de motivation ou un CV', 'trouver-un-emploi', 'preparer-sa-candidature--realiser-un-cv-et-ou-une-lettre-de-motivation'),
        ('Préparer une candidature, Rédiger une lettre de motivation ou un CV', 'trouver-un-job', 'preparer-sa-candidature--realiser-un-cv-et-ou-une-lettre-de-motivation'),
        ...
        ('Faire garder mes enfants', 'famille-et-vie-quotidienne', ''),
        ...
        ('Faire garder mes enfants', 'famille-et-vie-quotidienne', 'famille--garde-denfants'),
        ('Créer ou reprendre une entreprise', 'creer-ou-reprendre-une-entreprise', 'creation-activite--structurer-son-projet-de-creation-dentreprise'),
        ('Créer ou reprendre une entreprise', 'creer-ou-reprendre-une-entreprise', 'creation-activite--definir-son-projet-de-creation-dentreprise'),
        ('Réparer mon vélo', 'transport-et-mobilite', 'mobilite--entretenir-reparer-son-vehicule'),
        ('Préparer une candidature, Rédiger une lettre de motivation ou un CV', 'trouver-un-emploi', 'preparer-sa-candidature--realiser-un-cv-et-ou-une-lettre-de-motivation'),
        ('Acheter ou louer une voiture sans permis, "Scooter, trottinette..."', 'transport-et-mobilite', 'mobilite--louer-un-vehicule'),
        ('Acheter ou louer une voiture sans permis, "Scooter, trottinette..."', 'transport-et-mobilite', 'mobilite--acheter-un-vehicule-motorise')
