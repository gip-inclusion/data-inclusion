...
final AS (
    ...
    LEFT JOIN arrondissements ON structures.ville_code_commune = arrondissements.code
    LEFT JOIN communes_associees_deleguees ON structures.ville_code_commune = communes_associees_deleguees.code
)
