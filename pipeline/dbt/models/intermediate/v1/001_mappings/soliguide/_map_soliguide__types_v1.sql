...
FROM (
    ...
    ('abortion',                              'accompagnement'),
    ('access_to_housing',                     'accompagnement'),
    ('addiction_care',                        'accompagnement'),
    ('addiction_prevention_and_material',     'accompagnement'),
    ('administrative_assistance',             'accompagnement'),
    ('affective_life',                        'accompagnement'),
    ...
    ('emergency_contraception',               'aide-materielle'),
    ...
    ('mental_health_education',               'formation'),
    ...
    ('sexual_health_education',               'accompagnement'),
    ('sexual_health_vaccination',             'aide-materielle'),
    ('sexual_violence_support',               'accompagnement'),
    ...
    ('sti_prevention_testing',                'aide-materielle'),
    ('support_groups',                        'accompagnement'),
