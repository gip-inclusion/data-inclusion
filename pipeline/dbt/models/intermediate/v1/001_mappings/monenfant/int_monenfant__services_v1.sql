    ...
    SELECT
        ...
        ARRAY_TO_STRING(
            ARRAY[
                ...
                CASE
                    WHEN LENGTH(creches.description__projet) >= 200
                        THEN '## Le projet pédagogique :' || E'\n\n' || creches.description__projet
                END
            ],
            E'\n\n'
        )                                                                                  AS "description",
        'https://monenfant.fr/que-recherchez-vous/mode-d-accueil/' || creches.structure_id AS "lien_source",
