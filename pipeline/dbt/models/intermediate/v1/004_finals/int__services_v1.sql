...
SELECT
    ...
    CASE
        ...
        WHEN services.zone_eligibilite_type = 'commune'
            THEN ARRAY[adresses.code_insee]
        WHEN services.zone_eligibilite_type = 'epci'
            THEN ARRAY[adresses.code_epci]
        WHEN services.zone_eligibilite_type = 'departement'
            THEN ARRAY[adresses.code_departement]
        WHEN services.zone_eligibilite_type = 'region'
