...
services AS (
    SELECT
        ...
        NULLIF(ARRAY(SELECT JSONB_ARRAY_ELEMENTS_TEXT(data -> 'mobilisable_par')), '{}')                    AS "mobilisable_par",
        NULLIF(ARRAY(SELECT JSONB_ARRAY_ELEMENTS_TEXT(data -> 'modes_mobilisation')), '{}')                 AS "modes_mobilisation",
        ...
        NULLIF(ARRAY(SELECT JSONB_ARRAY_ELEMENTS_TEXT(data -> 'modes_accueil')), '{}')                      AS "modes_accueil",
        NULLIF(TRIM(data ->> 'presentation_resume'), '')                                                    AS "presentation_resume",
        NULLIF(TRIM(data ->> 'presentation_detail'), '')                                                    AS "presentation_detail",
        NULLIF(ARRAY(SELECT JSONB_ARRAY_ELEMENTS_TEXT(data -> 'publics')), '{}')                            AS "publics",
        ...
        NULLIF(ARRAY(SELECT JSONB_ARRAY_ELEMENTS_TEXT(data -> 'thematiques')), '{}')                        AS "thematiques",
        ...
        NULLIF(ARRAY(SELECT JSONB_ARRAY_ELEMENTS_TEXT(data -> 'zone_eligibilite')), '{}')                   AS "zone_eligibilite",
