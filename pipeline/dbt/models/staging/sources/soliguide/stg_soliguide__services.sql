...
services AS (
    SELECT
        ...
        NULLIF(TRIM(processings.html_to_markdown(services.data ->> 'description')), '')                                   AS "description",
        ...
        NULLIF(TRIM(processings.html_to_markdown(services.data #>> '{modalities,other}')), '')                            AS "modalities__other",
