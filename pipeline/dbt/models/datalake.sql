    ...
    {{
        dbt_utils.union_relations(
            relations=[
                ...
                source('mediation_numerique_cd17', 'structures'),
                source('mediation_numerique_cd17', 'services'),
                source('mediation_numerique_cd23', 'structures'),
                source('mediation_numerique_cd23', 'services'),
                source('mediation_numerique_cd28_appui_territorial', 'structures'),
                source('mediation_numerique_cd28_appui_territorial', 'services'),
                ...
                source('mediation_numerique_etapes_numerique', 'structures'),
                source('mediation_numerique_etapes_numerique', 'services'),
